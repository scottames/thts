---
name: thts-integrate
description: Activate thoughts/ integration for the current task. Use when you want to check existing context and write findings to thoughts/.
---
...
Read and apply the full integration instructions from AGENTS.md in .codex/.

**For this task specifically:**

1. Before starting, use `thoughts-locator` agent to check for existing context
