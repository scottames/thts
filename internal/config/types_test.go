...
// NOTE: TestCountReposUsingProfile has been moved to state_test.go
// as CountReposUsingProfile is now a method on State, not Config.

// NOTE: TestGetReposUsingProfile has been moved to state_test.go
// as GetReposUsingProfile is now a method on State, not Config.

// NOTE: TestCountReposUsingProfileWithImplicit has been moved to state_test.go
// as CountReposUsingProfileWithImplicit is now a method on State, not Config.
